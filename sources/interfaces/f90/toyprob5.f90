...
! File : toyprob5.f90
!
! This is equal toyprob, but A is not full-rank.
! ------------------------------------------------------------------
...
subroutine inip(n, x, l, u, m, b, lambda, annz, alin, acol, aval, flag)
  ...
  ! Initial point
  x = (/ - 2.0d0, - 4.0d0, 1.40d+01 /)

  ! Lower and upper bounds
  l = (/ (-10.0d0, i=1, n-1), -1.0d+20 /)
  u = (/ ( 10.0d0, i=1, n-1),  1.0d+20 /)
  ...
  alin = (/     1,       1,     2,     2,     3,       3 /)
  acol = (/     1,       2,     2,     3,     1,       2 /)
  aval = (/ 1.0d0, - 1.0d0, 2.0d0, 1.0d0, 2.0d0, - 2.0d0 /)
