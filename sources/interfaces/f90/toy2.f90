...
subroutine inip(n, x, l, u, m, b, lambda, annz, arow, acol, aval, flag)
  ...
  ! Problem data
  arow(1:annz) = [     1,     1,       1,       2,     2,       3,     3,     4,     4,       4 ]
  acol(1:annz) = [     1,     2,       4,       2,     3,       2,     3,     1,     2,       4 ]
  aval(1:annz) = [ 1.0d0, 1.0d0, - 3.0d0, - 2.0d0, 1.0d0, - 4.0d0, 2.0d0, 2.0d0, 2.0d0, - 6.0d0 ]

  b(1:m) = [ 1.0d0, 2.0d0, 4.0d0, 2.0d0 ]
